...
class Shop_Order(models.Model):
    ...
    shop_id = models.PositiveIntegerField()
    user_id = models.PositiveIntegerField()
    user_address_id = models.CharField(max_length=36, null=True)
    payment_id = models.CharField(max_length=36, null=True)
    product_shipment_id = models.CharField(max_length=36, null=True)
    shop_name = models.CharField(max_length=50, null=True)
    first_name = models.CharField(max_length=50, null=True)
    last_name = models.CharField(max_length=50, null=True)
    waybill_number = models.CharField(max_length=25, null=True)
    name_in_address = models.CharField(max_length=50, null=True)
    phone = models.CharField(max_length=50, null=True)
    full_address = models.CharField(max_length=50, null=True)
    product_shipment_desc = models.CharField(max_length=255, null=True)
...
class Shop_Order_Details(models.Model):
    ...
    product_id = models.PositiveIntegerField()
    product_spec_id = models.PositiveIntegerField(null=True)
    product_shipment_id = models.CharField(max_length=36, null=True)
